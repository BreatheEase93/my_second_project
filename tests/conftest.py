...
def basic_df():
    ...
    return pd.DataFrame(
        {
            'Дата платежа': ['15.01.2024', '10.02.2024', '05.03.2024', '20.12.2023'],
            'Категория': ['Еда', 'Еда', 'Транспорт', 'Еда'],
            'Сумма операции': [1000, 1500, 500, 800],
            'Статус': ['OK', 'OK', 'OK', 'OK'],
        }
    )
...
def empty_df():
    """Пустой DataFrame"""
    return pd.DataFrame(columns=['Дата платежа', 'Категория', 'Сумма операции', 'Статус'])
